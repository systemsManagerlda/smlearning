...
export type BlockContent1 = Array<{
  children?: Array<{
    marks?: Array<string>;
    text?: string;
    _type: "span";
...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | LessonCompletion | Module | Lesson | Enrollment | BlockContent1 | Course | Instructor | Student | Post | Author | Category | Slug | BlockContent | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata;
...
// Source: src/sanity/lib/lessons/getCourseProgress.ts
